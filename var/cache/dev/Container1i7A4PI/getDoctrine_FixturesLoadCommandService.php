...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = new \App\DataFixtures\UserFixture(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')));

        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ProjectFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\TaskFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\TeamFixture($b), 'groups' => []], 4 => ['fixture' => $b, 'groups' => []]]);
