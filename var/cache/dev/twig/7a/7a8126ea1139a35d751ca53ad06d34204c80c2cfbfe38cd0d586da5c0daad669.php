...
/* my_tasks.html.twig */
class __TwigTemplate_7d0a95c915e2d7d0d58af72a566926fc8b08495d6e8f96c3696e1d1f0ccca851 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "my_tasks.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "my_tasks.html.twig"));
...
";
    ...
    public function block_page_content($context, array $blocks = [])
    {
        ...
        // line 13
        echo "    ";
        if ( !(isset($context["tasks"]) || array_key_exists("tasks", $context) ? $context["tasks"] : (function () { throw new RuntimeError('Variable "tasks" does not exist.', 13, $this->source); })())) {
            // line 14
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                // line 18
                echo "            ";
                $context["vars"] = ["route" => "app_show_task", "project_id" => (isset($context["project_id"]) || array_key_exists("project_id", $context) ? $context["project_id"] : (function () { throw new RuntimeError('Variable "project_id" does not exist.', 18, $this->source); })()), "task_id" => twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, false, 18)];
                // line 19
                echo "            ";
    ...
    {
        return array (  160 => 21,  146 => 20,  143 => 19,  140 => 18,  137 => 17,  119 => 16,  115 => 14,  112 => 13,  102 => 12,  84 => 7,  73 => 4,  63 => 3,  52 => 1,  50 => 10,  37 => 1,);
    }
...
{% block page_title %}
    <p style=\"font-size: 1.75rem;\">Moji zadaci</p>
{% endblock %}

{% block new_card %}
{% endblock %}

{% set route = 'app_user_add_task' %}
...
{% block page_content %}
    ...
    {% else %}
        {% for item in tasks %}
            {% set project_id = item.project.id %}
            {% set vars = {route : 'app_show_task', 'project_id': project_id, 'task_id': item.id} %}
            {% include 'card/card.html.twig' %}
        {% endfor %}
    {% endif %}
{% endblock %}", "my_tasks.html.twig", "/home/vladimir/PhpstormProjects/project-manager/templates/my_tasks.html.twig");
    }
}
