...
/* index.html.twig */
class __TwigTemplate_9960aadb738bd9c00bb99620fccf7ef572ef1433e5a7f40318a38de9f88001ab extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 10
        echo "        ";
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 10, $this->source); })()), "request", [], "any", false, false, false, 10), "attributes", [], "any", false, false, false, 10), "get", [0 => "_route"], "method", false, false, false, 10), "app_homepage"))) {
            // line 11
            echo "            ";
        ...
        ";
        // line 22
        $this->loadTemplate("display_options.html.twig", "index.html.twig", 22)->display($context);
        // line 23
        echo "
    </div>
    ...
    public function block_new_card($context, array $blocks = [])
    {
        ...
        // line 17
        echo "            ";
        $this->loadTemplate("card/card_new.html.twig", "index.html.twig", 17)->display(twig_array_merge($context, (isset($context["vars"]) || array_key_exists("vars", $context) ? $context["vars"] : (function () { throw new RuntimeError('Variable "vars" does not exist.', 17, $this->source); })())));
        // line 18
        echo "        ";
    ...
    {
        return array (  203 => 28,  193 => 27,  175 => 20,  165 => 18,  162 => 17,  152 => 16,  133 => 7,  122 => 30,  120 => 27,  114 => 23,  112 => 22,  109 => 21,  107 => 20,  104 => 19,  102 => 16,  99 => 15,  96 => 14,  93 => 13,  89 => 12,  86 => 11,  83 => 10,  80 => 8,  78 => 7,  75 => 6,  72 => 4,  62 => 3,  39 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"text-center\">
        {% block page_title %}pJ{% endblock %}

        {# ako je home page, onda pokazi dodaj projekat karticu #}
        {% if app.request.attributes.get('_route') == 'app_homepage' %}
            {% set vars = {'route': 'app_add_project', 'title': 'Novi projekat'} %}
        {% else %} {# pokazi dodaj task karticu #}
            {% set vars = {'route': 'app_add_task', 'title': 'Novi zadatak'} %}
        {% endif %}

        {% block new_card %}
            {% include 'card/card_new.html.twig' with vars %}
        {% endblock %}

        {% block pre_content %}{% endblock %}

        {% include \"display_options.html.twig\" %}
    ...
    {# </div> #}
{% endblock %}", "index.html.twig", "/home/vladimir/PhpstormProjects/pJ/templates/index.html.twig");
    }
}
