...
/* task.html.twig */
class __TwigTemplate_b2cc48a77e2ee5b9c183bf4f1aad0941aef79aefc97d3e0c3024de68a2917533 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_page_content($context, array $blocks = [])
    {
        ...
        echo "
                ...
                <p>Datum kreiranja: </p> ";
        // line 20
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["task"]) || array_key_exists("task", $context) ? $context["task"] : (function () { throw new RuntimeError('Variable "task" does not exist.', 20, $this->source); })()), "creationDate", [], "any", false, false, false, 20), "d-m-Y"), "html", null, true);
        echo "
            </div>
            <div class=\"col\">
        ...
        echo "
                ...
                <p>Rok završetka: </p> ";
        // line 25
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["task"]) || array_key_exists("task", $context) ? $context["task"] : (function () { throw new RuntimeError('Variable "task" does not exist.', 25, $this->source); })()), "endDate", [], "any", false, false, false, 25), "F d, Y", "Europe/Serbia"), "html", null, true);
        echo "
            </div>
            <div class=\"col\">
                <p>Prioritet: </p> ";
        ...
        echo "
                ...
                <p>: </p> ";
        // line 35
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["task"]) || array_key_exists("task", $context) ? $context["task"] : (function () { throw new RuntimeError('Variable "task" does not exist.', 35, $this->source); })()), "endDate", [], "any", false, false, false, 35), "F d, Y"), "html", null, true);
        echo "
            </div>
        </div>
    </div>
";
    ...
    {
        return array (  163 => 35,  158 => 33,  152 => 30,  147 => 28,  141 => 25,  136 => 23,  130 => 20,  121 => 18,  116 => 15,  106 => 14,  88 => 11,  74 => 6,  70 => 4,  60 => 3,  37 => 1,);
    }
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col\">
                ...
                <div class=\"padding-10\"></div>
                <p>Datum kreiranja: </p> {{ task.creationDate|date('d-m-Y') }}
            </div>
            <div class=\"col\">
                <p>Trenutno zadužen: </p> {{ task.userWorking.email }}
                <div class=\"padding-10\"></div>
                <p>Rok završetka: </p> {{ task.endDate|date('F d, Y', 'Europe/Serbia') }}
            </div>
            <div class=\"col\">
